<div id="addUserOverlay" class="hidden">
  <div class="z-50 bg-black bg-opacity-25 backdrop-blur-lg fixed inset-0 flex items-center justify-center">
    <div class="">
      <form class="relative" action="/users/add" method="POST" enctype="multipart/form-data">
        <div class="flex flex-col gap-4 bg-white p-8 rounded-lg shadow-lg">
          <h2 class="text-2xl font-bold">Add user</h2>

          <div class="flex flex-col gap-4">
            <label for="first_name">First name</label>
            <input type="text" name="first_name" id="first_name" class="p-2 border border-gray-300 rounded-lg" required>
          </div>
          ...
          <div class="flex flex-col gap-4">
            ...
            <input type="file" name="user_image" id="user_image" class="p-2 border border-gray-300 rounded-lg">
          </div>
